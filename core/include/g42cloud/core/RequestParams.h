...
#ifndef G42CLOUD_SDK_CORE_REQUESTPARAMS_H
#define G42CLOUD_SDK_CORE_REQUESTPARAMS_H
#include <string>
#include <set>
...
class G42CLOUD_CORE_EXPORT RequestParams {
public:
    RequestParams();
...
#endif // G42CLOUD_SDK_CORE_REQUESTPARAMS_H