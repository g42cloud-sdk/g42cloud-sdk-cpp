...
#ifndef G42CLOUD_SDK_CORE_UTILS_ModelBase_H_
#define G42CLOUD_SDK_CORE_UTILS_ModelBase_H_
...
namespace Core {
namespace Utils {
class G42CLOUD_CORE_EXPORT ModelBase {
public:
    ModelBase();
    virtual ~ModelBase();
...
#endif // G42CLOUD_SDK_CORE_UTILS_ModelBase_H_