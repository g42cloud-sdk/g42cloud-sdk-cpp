...
#ifndef G42CLOUD_SDK_CORE_UTILS_HttpContent_H_
#define G42CLOUD_SDK_CORE_UTILS_HttpContent_H_
...
namespace Core {
namespace Utils {
class G42CLOUD_CORE_EXPORT HttpContent {
public:
    HttpContent();
    virtual ~HttpContent();
...
#endif // G42CLOUD_SDK_CORE_UTILS_HttpContent_H_
