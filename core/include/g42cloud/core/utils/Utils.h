...
#ifndef G42CLOUD_SDK_CORE_UTILS_UTILS_H
#define G42CLOUD_SDK_CORE_UTILS_UTILS_H
#include <string>
#include <ctime>
#include <locale>
#include <codecvt>
...
G42CLOUD_CORE_EXPORT std::string uriDecode(std::string &str);
G42CLOUD_CORE_EXPORT std::string uriEncode(std::string &str, bool path = false);
...
#endif // G42CLOUD_SDK_CORE_UTILS_UTILS_H