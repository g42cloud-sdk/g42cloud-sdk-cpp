...
#ifndef G42CLOUD_SDK_CORE_AUTH_IAMSERVICE_H
#define G42CLOUD_SDK_CORE_AUTH_IAMSERVICE_H
...
class G42CLOUD_CORE_EXPORT IamService {
public:
...
private:
    ...
    const std::string DefaultIamEndpoint = "https://iam.ae-ad-1.g42cloud.com";
};
}
}
}
}
#endif //G42CLOUD_CPP_SDK_V3_IAMSERVICE_H
