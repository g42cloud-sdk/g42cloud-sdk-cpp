...
#ifndef G42CLOUD_SDK_CORE_AUTH_SIGNER_H
#define G42CLOUD_SDK_CORE_AUTH_SIGNER_H
#include <memory>
#include <iostream>
#include <string>
#include <vector>
...
#include <g42cloud/core/utils/Hasher.h>
...
namespace Core {
namespace Auth {
class G42CLOUD_CORE_EXPORT Signer {
public:
    Signer();
    ...
    std::string createSignature(G42Cloud::Sdk::Core::RequestParams &request);
...
#endif // G42CLOUD_SDK_CORE_AUTH_SIGNER_H