...
#ifndef G42CLOUD_SDK_CORE_AUTH_BASICCREDENTIALS_H
#define G42CLOUD_SDK_CORE_AUTH_BASICCREDENTIALS_H
#include <memory>
#include <string>
...
namespace Core {
namespace Auth {
class G42CLOUD_CORE_EXPORT BasicCredentials : public Credentials {
public:
    BasicCredentials();
...
#endif // G42CLOUD_SDK_CORE_AUTH_BASICCREDENTIALS_H
