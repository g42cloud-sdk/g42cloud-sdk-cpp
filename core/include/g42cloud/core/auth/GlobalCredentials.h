...
#ifndef G42CLOUD_SDK_CORE_AUTH_GLOBALCREDENTIALS_H
#define G42CLOUD_SDK_CORE_AUTH_GLOBALCREDENTIALS_H
#include <memory>
#include <string>
...
namespace Core {
namespace Auth {
class G42CLOUD_CORE_EXPORT GlobalCredentials : public Credentials {
public:
    GlobalCredentials();
...
protected:
    std::string processAuthRequest(G42Cloud::Sdk::Core::RequestParams &requestParams) override;
...
#endif // G42CLOUD_SDK_CORE_AUTH_GLOBALCREDENTIALS_H
