...
#ifndef G42CLOUD_SDK_CORE_HTTP_HTTPCONFIG_H
#define G42CLOUD_SDK_CORE_HTTP_HTTPCONFIG_H
...
namespace Core {
namespace Http {
class G42CLOUD_CORE_EXPORT HttpConfig {
public:
...
#endif // G42CLOUD_SDK_CORE_HTTP_HTTPCONFIG_H