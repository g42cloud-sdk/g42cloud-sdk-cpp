...
#ifndef G42CLOUD_SDK_CORE_HTTP_HTTPREQUEST_H
#define G42CLOUD_SDK_CORE_HTTP_HTTPREQUEST_H
...
class G42CLOUD_CORE_EXPORT HttpRequest {
public:
    HttpRequest();
    ~HttpRequest();
...
#endif // G42CLOUD_SDK_CORE_HTTP_HTTPREQUEST_H