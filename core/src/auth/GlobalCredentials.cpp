...
#include <g42cloud/core/auth/Signer.h>
#include <g42cloud/core/auth/GlobalCredentials.h>
#include <g42cloud/core/auth/AuthCache.h>
...
std::string GlobalCredentials::processAuthRequest(G42Cloud::Sdk::Core::RequestParams &requestParams)
{
